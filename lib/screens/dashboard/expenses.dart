...
class Expense_Report extends StatelessWidget {
  var search = TextEditingController();
  Expense_Report({super.key});
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: SafeArea(
        ...
        child: Column(
          children: [
            const Header(title: "Expense Report"),
            SizedBox(
              height: 10.sp,
            ),
            Padding(
            ...
            const Padding(
              ...
              child: Wrap(
                runSpacing: 20,
                children: [
                  Sales(product: "Payment for Rent", price: 200),
                  Sales(product: "Transport Expenses", price: 40),
                ],
              ),
            ),
          ],
